Reggae=function(target){
  this.isNodeSpec=function(){return this[0] && j.type(this[0],'str') && this[1] && j.type(this[1])};
  ...
  var domFuncs={
    ...
    'num': function(){ return document.createTextNode(this);},
    ...
    'arr': function(){
      if(this.isNodeSpec()) {
        ...
        return $(this).map(function(e){return Reggae.call(e).toDom()})
      }
    }
  }
  this.toDom=domFuncs[j.type(this)];
  if (target) {
    var t=j.type(target,'str') ? $(target) : target;
    var d=this.toDom();
    if (j.type(d,'arr')){
      t.html('');
      $(d).each(function(e){ t.append($(e)); });
    } else {
      t.html(d);
    }
  }

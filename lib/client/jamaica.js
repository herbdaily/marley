...
J={
    ...
    error:function(stat,json){
      ...
      if (attrs.error_type=='validation') {
        for (col in attrs.error_details) {
          $('#'+frm_id+' [id$=__'+col+']').addClass('errorCol').after(Reggae.call(["p",{"class":"errorMsg"},attrs.error_details[col]]));
        }
      }
    },
  },
  ...
  menuClick:function(e){
    ...
    J.ajax(J.make_ajax_params.call(this,{success:function(json){Reggae.call(json,target)}}))
  },

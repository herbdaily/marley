...
pl(function(){
  ...
  pl('body').bind('ajaxStart',function(){pl('body').css('cursor','wait');alert('asdfa')});
  pl('body').bind('ajaxComplete',function(){pl('body').css('cursor','default');});
  pl('body').bind('ajaxError',j.showError);
});

j={
  default_ajax:function(){return new pl.getAjax({dataType:'json', error:j.showError})},

...
VALUE_INDEX=3;
String.prototype.humanize=function(){return $.map(this.replace(/^_/,'').split('_'),function(w){return w[0].toUpperCase()+w.slice(1)}).join(' ');}
$.domReady(function(){
...
j={
  ...
  type:function(o,test) {
    var t=j.known_types[Object.prototype.toString.call(o).replace(/\S+\s/,'').replace(/\]/,'')];      
  }
  ...
  make_ajax_params:function(params){
    return j.extend(params,
        j.extend(j.get_callbacks.call(this,j.ajax_defaults),{
          dataType:'json',

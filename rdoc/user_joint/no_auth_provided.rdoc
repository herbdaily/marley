...
example: read new user form but not user list
  ...
  => [:instance, {:new_rec=>true, :actions=>[], :schema=>[["text", :name, 0, nil], ["text", :email, 0, nil], ["date", :birthday, 0, nil], ["text", :description, 0, nil], ["text", :password, 4, nil], ["text", :confirm_password, 4, nil]], :name=>"user", :url=>"/user/"}, []]

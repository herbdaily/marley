...
example: read new user form but not user list
  ...
  => [:instance, {:actions=>[], :schema=>[["text", :name, 0, nil], ["text", :email, 0, nil], ["date", :birthday, 0, nil], [:password, :password, 4], [:password, :confirm_password, 4]], :url=>"/user/", :name=>"user", :new_rec=>true}, []]

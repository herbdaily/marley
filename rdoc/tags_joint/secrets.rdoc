...
=> [{:tag_id=>6, :message_id=>1, :id=>7, :user_id=>nil}]
...
>> @secret=@client.read({}, :method => 'new')
=> [:instance, {:schema=>[["integer", :user_id, 1, 2], ["text", :name, 4, nil], ["text", :message, 0, nil], ["text", :_private_tags, 0, nil]], :url=>"/secret/", :new_rec=>true, :actions=>nil, :name=>"secret"}, []]

>> @client.create(@secret.set_values(:name => 'user2 secret', :_private_tags => 'foo,bar'))
=> [:instance, {:schema=>[["integer", :id, 2, 2], ["integer", :user_id, 1, 2], ["text", :name, 4, "user2 secret"], ["text", :message, 0, nil], ["text", :_private_tags, 0, "foo, bar"]], :url=>"/secret/2", :new_rec=>false, :actions=>nil, :name=>"secret"}, []]

>> @secret=@client.read[0]
=> [:instance, {:schema=>[["integer", :id, 2, 2], ["integer", :user_id, 1, 2], ["text", :name, 4, "user2 secret"], ["text", :message, 0, nil], ["text", :_private_tags, 0, "foo, bar"]], :url=>"/secret/2", :new_rec=>false, :actions=>nil, :name=>"secret"}, []]
>> @client.update(@secret.set_values(:_private_tags => "#{@secret.col_value(:_private_tags)},baz,bat"), :url => @secret.url)
=> [[:instance, {:schema=>[["integer", :id, 2, 2], ["integer", :user_id, 1, 2], ["text", :name, 4, "user2 secret"], ["text", :message, 0, nil], ["text", :_private_tags, 0, "foo, bar, baz, bat"]], :url=>"/secret/2", :new_rec=>false, :actions=>nil, :name=>"secret"}, []]]

>> @secret=@client.read[0]
=> [:instance, {:schema=>[["integer", :id, 2, 2], ["integer", :user_id, 1, 2], ["text", :name, 4, "user2 secret"], ["text", :message, 0, nil], ["text", :_private_tags, 0, "foo, bar, baz, bat"]], :url=>"/secret/2", :new_rec=>false, :actions=>nil, :name=>"secret"}, []]
>> @client.update(@secret.set_values(:_private_tags => "boo"), :url => @secret.url)
=> [[:instance, {:schema=>[["integer", :id, 2, 2], ["integer", :user_id, 1, 2], ["text", :name, 4, "user2 secret"], ["text", :message, 0, nil], ["text", :_private_tags, 0, "boo"]], :url=>"/secret/2", :new_rec=>false, :actions=>nil, :name=>"secret"}, []]]
...
>> DB[:messages_tags].all
=> [{:tag_id=>6, :message_id=>1, :id=>7, :user_id=>nil}, {:tag_id=>12, :message_id=>2, :id=>14, :user_id=>nil}]

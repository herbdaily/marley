...
=> [:instance, {:url=>"/private_message/1", :schema=>[["text", :recipients, 0, "user2"], ["text", :author, 2, "user1"], ["integer", :id, 2, 1], ["integer", :user_id, 3, 1], ["text", :title, 4, "asdf"], ["text", :content, 0, nil]], :name=>"private_message", :new_rec=>false, :actions=>{:get=>"reply"}}, []]
...
=> [:instance, {:url=>"/private_message/1", :schema=>[["text", :recipients, 0, "user3,user4"], ["text", :author, 2, "user2"], ["integer", :id, 2, 1], ["integer", :user_id, 3, 2], ["text", :title, 4, "message1"], ["text", :content, 0, nil]], :name=>"private_message", :new_rec=>false, :actions=>[:reply, :reply_all]}, []]
>> @client3.read
